...
INDEX_TEMPLATE = r"""<html>
<head>
<meta charset="UTF-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>zionmedia fs: ${header}</title>
...
def fun(dir,rootdir):
    ...
    filenames = [fname for fname in sorted(os.listdir(dir))
            ...
            and fname[0]!='_' and fname[0]!='.']
    dirnames = [fname for fname in sorted(os.listdir(dir))
            if fname not in EXCLUDED  and fname[0]!='_' and fname[0]!='.']
    dirnames = [fname for fname in dirnames 
            if fname not in filenames and fname[0]!='_' and fname[0]!='.']
